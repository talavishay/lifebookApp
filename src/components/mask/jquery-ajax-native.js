...
//      jQuery Ajax Native Plugin may be freely distributed under the MIT license.
    var ajaxSettings = App.$.ajaxSettings;
    ...
    var support = {},
        ...
        xhrCallbacks = {},
        xhrSupported = App.$.ajaxSettings.xhr();
    // Support: IE9
    ...
    App.$.ajaxTransport('native', function ( options ) {
        var callback;
    ...
    //App.$.getNative wrapper
    App.$.getBlob = function ( url, callback ) {
        return App.$.ajax({
            dataType: 'native',
            url: url,
            xhrFields: {
