module.exports = App.Backbone.Model.extend({
		...
		initialize : function(object){
			...
			this.set("selectFontSize",  this._selectInt(15, 150, 5));
			...
			this.set("selectFontFamily",  [ "nootregular", "Times New Roman", "Alef",  "stam_ashkenaz_clmmedium", "stam", "carmela",	"mirimedium", "Arial"]);
